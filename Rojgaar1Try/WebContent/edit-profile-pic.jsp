...
<html>
    <head>
        ...
        <title> RojgaarLelo :- Upload Profile Pic </title>
    </head>
    <body>
		...
		<div class="row">
			...
			<div class="col-md-8"> 
				<div class="row" style="border: 1px solid red; box-shadow: 0px 0px 2px red; border-radius: 3px">
					<div class="col-md-3">
						<img alt="image doesn't fetch properly" src="profilepics/<jsp:expression>profile_pic</jsp:expression>" height="150" style="border-radius: 75px" />
					</div>
					<div class="col-md-9">
